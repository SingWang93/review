...
class Ab(models.Model):
    tag = models.ForeignKey(Tag, related_name="ab_tag", null=True, verbose_name="平台")
    ...
    createuser = models.ForeignKey(User, related_name="ab_create_user")
    createtime = models.DateTimeField(auto_now_add=True)
    updateuser = models.ForeignKey(User, null=True, related_name="ab_update_user")
...
class Ab_log(models.Model):
    ab = models.ForeignKey(Ab, related_name="log_ab", null=True)
    account = models.ForeignKey(Account, related_name="log_ab_account")
    createuser = models.ForeignKey(User, related_name="log_ab_user")
    createtime = models.DateTimeField(auto_now_add=True)
